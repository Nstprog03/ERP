...
<html>
  <head>
    <meta charset="utf-8">
    <title>View Assessment Report Details</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Assessment Report Details</span></a>
              ...
              <div class="row">
                ...
                <div class="col-md">
                  <div class="row">
                    ...
                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Assessment Report Type</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['ass_report_type'] ?></span>
                    </div>
                    </div>                    

                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Assessment Report Name</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['ass_report_name'] ?></span>
                    </div>
                    </div>                     
