  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Create New Audit Report</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Create Audit Report</div>
              <div class="card-body">
        ...
        ?>
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <select select="selected" name="ad_report_type" class="form-control">
                      ...
                      <option>Gst Audit Report</option>
                       <option>IT Return Reoport</option>
                    </select>
                  </div>
                ...
                ?>                              
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" name="acknow_no" placeholder="Enter Acknowledgement No." class="form-control">
                    </div>

                     <div class="form-group col-md-4">
                      <label for="date_of_filling">Date Of Filling</label>
                      <input type="text" name="date_of_filling" placeholder="Select Date" class="form-control datepicker"  autocomplete="off">
                    </div>
                ...
                ?>                              
                 ...
                 <div class="form-group col-md-4">
                      ...
                      <input type="text" name="due_date" id="due_date" placeholder="Select Date" class="form-control datepicker"  autocomplete="off">
                    </div>
