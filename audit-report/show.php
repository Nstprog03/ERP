    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Audit Report Show</span></a>
              ...
              <div class="row">
                ...
                <div class="col-md">
                  <div class="row">
                    ...
                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Report Type</h6>
                    </div>
                    <div class="form-control view-form">  
                     <span><?php echo $row['ad_report_type'] ?></span>
                    </div>
                    </div>
                    ...
                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Acknowledgement No.</h6>
                    </div>
                    <div class="form-control view-form">  
                     <span><?php echo $row['acknow_no'] ?></span>
                    </div>
                    </div>
                    ...
                    <?php
                      ...
                      <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Date Of Filling</h6>
                    </div>
                    <div class="form-control view-form">  
                     <span><?php echo $date_of_filling ?></span>
                    </div>
                    </div>
                     ...
                     <?php
                              ...
                              $sql2 = "select startdate,enddate from financial_year where id='".$row['assessment_year_id']."'";
                              ...
                              $a_syear = date("Y", strtotime($row2['startdate']));

                              $a_eyear = date("Y", strtotime($row2['enddate']));

                              $assessment_year=$a_syear.'-'.$a_eyear;
                     ...
                     <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Assessment Year</h6>
                    </div>
                    <div class="form-control view-form">  
                     <span><?php echo $assessment_year ?></span>
                    </div>
                    </div>
                     ...
                     <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Due Date Of Filling</h6>
                    </div>
                    <div class="form-control view-form">  
