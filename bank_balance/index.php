      ...
      <div id="sidebarnav"></div>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <a class="navbar-brand" href="home.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Bank Balance</span></a>
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <label for="firm">Select Bank</label>
                    <?php
                        ...
                        if(mysqli_num_rows($result) > 0){
                          ...
                          $bank = json_decode($row['bankDetails'],true);
                        }
                    ?>                      
                <select name="bank" class="form-control">
                <?php   
                  if(isset($bank)){
                    foreach ($bank as $bData) 
                    {
                      if($bData['bank_ac_number'] != ""){
                        echo "<option  value='".$bData['bank_ac_number']."'>".$bData['bank_name']. "</option>";
                      }
                    }
                  }
                ?>                              
