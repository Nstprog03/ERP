    ...
    <div id="content">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
         <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Edit Bank</span></a>
            ...
            <form class="" action="" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="ifsc"  placeholder="Enter IFSC Code" onkeypress="return IFSCValidation(event)"  id="ifsc" maxlength="11"value="<?php echo $row['ifsc']; ?>">
                </div>

                <div class="form-group col-sm-4">
                  <label for="address">Address</label>
                  <input type="text" class="form-control" name="address"  placeholder="Enter Address"  id="address" maxlength="11" value="<?php echo $row['address'] ?>">
                </div>
