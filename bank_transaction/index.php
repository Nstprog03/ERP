...
if(isset($_POST['submit'])){
  ...
  $_SESSION["bank_tran_firm"] = $firmDetails[0];
  $_SESSION["bank_tran_firm_id"] = $firmDetails[1];


  $_SESSION["bank_tran_financial_year"] = $_POST['financial_year'];
  ...
  $_SESSION["bank_tran_financial_year_id"] = $row3['id'];
  ...
  <body>
      ...
      <div id="sidebarnav"></div>
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Bank Transaction</span></a>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7">
            <div class="card">
              <div class="card-header">Bank Transaction</div>
