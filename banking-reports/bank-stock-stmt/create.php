...
<html>
  <head>
    <meta charset="utf-8">
    <title>Bank Stock Statement Create</title>
  ...
  <body>
    ...
    <div class="wrapper">
      ...
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Create New Bank Stock Statement Database</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Bank Stock Statement Database</div>
              <div class="card-body">
                <form class="" id="main-form" action="add.php" method="post" enctype="multipart/form-data">
                     <div class="row">
                ...
                <?php
                  $sql="SELECT Drawing_limit FROM bank_stock ORDER BY id DESC LIMIT 1";
                  $result = mysqli_query($conn, $sql);
                ...
                <div class="row">
                  <div class="form-group col-sm-6">
                      <label for="Drawing_limit">Drawing Power Limit <?php if(isset($row)){ echo '(Last Entry : '.$row['Drawing_limit'].')'; } ?></label>
                      <input type="text" name="Drawing_limit"class="form-control" placeholder="Enter Drawing Power Limit" onkeypress="return NumericValidate(event,this)">
                  </div>

                  <div class="form-group col-sm-6">
                      <label for="book_debt">Book Debit</label>
                      <select class="form-control" onchange="yesnoCheck(this);" name="book_debt">
                      ...
                      <div id="ifYes" style="display: none;">
                          ...
                          <label for="CA certified book debt "><b>CA certified </b> <input type="checkbox" name="certified_book"> </label>
                      </div>
                  </div>
                  ...
                  <div class="row dynamicWrapper" style="margin-left: 2px;">
...
/*Below Conde For Single File Preview Only*/
...
/*Below Conde For Mulitple Files File Preview Only*/
/*function readURL(input) {
      ...
      $("form#main-form input[type='file']").change(function(){
        readURL(this);
      });*/
