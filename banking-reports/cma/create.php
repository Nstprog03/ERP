...
<div class="wrapper">
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Create New CMA Report</span></a>
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto"></ul>
                            <ul class="navbar-nav">
                              <li class="nav-item mr-2"><a class="btn btn-outline-danger" href="index.php"><i class="fa fa-sign-out-alt"></i><span class="pl-1">Back</span></a></li>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">CMA Report Create</div>
              <div class="card-body">
                    ...
                    <div class=" form-group  col-sm-4 pl-0 imgcount dynamic_field_1">
                      <label class="image-label" for="cma">CMA Report Image 1</label>
                        <div class="image-upload dynamic_field">
                          ...
                          <input type="file" class="form-control" id="img1" onchange="readURL(this);" name="cma[]" value="">
                          <br>
