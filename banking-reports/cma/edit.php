...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "select * from cma where id=".$id;
  ...
  $store_path=$data[1]; // db store path
    ...
    $imgArr=array();
    $filecount = count($_FILES['cma']['tmp_name']);  
...
<div class="wrapper">
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Edit CMA Report</span></a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
       ...
       <!-- last change on Record START-->
          <?php
          $sqlLastChange="select username,updated_at from cma where id='".$row['id']."'";
              ...
              <div class="card-body">
                <form class="" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                      <label for="end_yr">End Year</label>
            ...
            if ($row['cma'] != '') {
              ...
              foreach ($prev as $key => $imging){
                  ...
                  $attend =  $dir.$imging;
                {
                  ...
                  { ?>
                        ...
                        <div class=" form-group  col-sm-4 pl-0 imgcount dynamic_field_<?= $key+1 ?>">
                          <label class="image-label" for="cma">CMA Report Image <?= $key+1 ?></label>
                            <div class="image-upload dynamic_field">
                              ...
                              <input type="file" class="form-control" id="img<?= $key+1 ?>" onchange="readURL(this);" name="cma[<?= $key?>]" value="">
                ...
                <div class=" form-group  col-sm-4 pl-0 imgcount dynamic_field_1">
                      <label class="image-label" for="cma">CMA Report Image 1</label>
                        <div class="image-upload dynamic_field">
                          ...
                          <input type="file" class="form-control" id="img1" onchange="readURL(this);" name="cma[1]" value="">
                          <br>
