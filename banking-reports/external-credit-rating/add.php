...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  $store_path=$data[1]; // db store path
    ...
    $timestamp=date("Y-m-d H:i:s");
		...
		if(!isset($errorMsg)){
			$sql = "insert into  credit_rating(firm, start_date, end_date, docimg,agency,rating,img_title,username,created_at,updated_at)
					values('".$firm."', '".$start_date."', '".$end_date."', '".$imgStore."', '".$agency."', '".$rating."', '".$imgTitle."', '".$username."', '".$timestamp."', '".$timestamp."')";
