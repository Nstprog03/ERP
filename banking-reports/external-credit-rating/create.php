...
<html>
  <head>
    <meta charset="utf-8">
    <title>External Credit Rating Report</title>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">External Credit Rating Report Create</div>
              <div class="card-body">
                ...
                <form class="" action="add.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input class="form-control datepicker" type="text" name="start_date" autocomplete="off" placeholder="Start Date">
                    </div>

                      <div class="form-group col-sm-4">
                      <label for="end_date">End Date</label>
                      <input class="form-control datepicker" type="text" name="end_date" autocomplete="off" placeholder="End Date">
                    </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-sm-4">
                      ...
                      <input class="form-control" type="text" name="agency" placeholder="Enter Agency Name">
                    </div>
