...
$dir = "/static_file_storage/"; 
  ...
  if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "select q.id,q.file,q.year,q.firm,q.form,q.status,q.quarter,p.party_name
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php">QIS Details</a>
...
if(in_array($attendExt, $attend_allowExt)) 
  ...
  <div class="label">
  <h6 class="title">Stock Report File</h6>
    </div>
    <div class="filed-form-control">  
  <img src="<?php echo $dir.$row['file'] ?>"  data-toggle="modal" data-target="#myModal" id="1" onerror="this.onerror=null; this.src='../../image/no-image.jpg'" height="300" width="300">
  </div>
