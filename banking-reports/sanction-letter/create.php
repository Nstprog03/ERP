  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Create New Sanction Report</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Sanction Report Create</div>
              <div class="card-body">
                ...
                <form class="" action="add.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input class="form-control datepicker" type="text" name="start_date" placeholder="Start Date" autocomplete="off">
                    </div>

                      <div class="form-group col-sm-4">
                      <label for="end_date">End Date</label>
                      <input class="form-control datepicker" type="text" name="end_date" placeholder="End Date" autocomplete="off">
                    </div>
                 ...
                 <div class="row">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input class="form-control" type="text" name="acc_no" placeholder="Enter Account Number">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="san_amt">Amount Sanction</label>
                      <input class="form-control" type="text" name="san_amt" placeholder="Enter Amount Sanction">
                    </div>
