...
<html>
  <head>
    <meta charset="utf-8">
    <title>Sanction Report Edit</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Sanction Report Edit</span></a>
        ...
        <!-- last change on Record START-->
          <?php
          $sqlLastChange="select username,updated_at from sanction where id='".$row['id']."'";
                ...
                <label for="firm">Firm</label>
                  ...
                  ?>
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input class="form-control datepicker" type="text" name="start_date" placeholder="Start Date" value="<?php echo $start_date; ?>" autocomplete="off">
                    </div>

                      <div class="form-group col-sm-4">
                      <label for="end_date">End Date</label>
                      <input class="form-control datepicker" type="text" name="end_date" placeholder="End Date" value="<?php echo $end_date; ?>" autocomplete="off">
                    </div>
                   </div>
                  ...
                  <div class="form-group col-sm-4">
                      ...
                      <input class="form-control" type="text" name="bank_name" placeholder="Enter Bank Name" value="<?php echo $row['bank_name']; ?>">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="acc_no">Account No.</label>
                      <input class="form-control" type="text" name="acc_no" placeholder="Enter Rating"  value="<?php echo $row['acc_no']; ?>">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="san_amt">Sanction Amount</label>
                      <input class="form-control" type="text" name="san_amt" placeholder="Enter Sanction Amount"  value="<?php echo $row['san_amount']; ?>">
                    </div>
