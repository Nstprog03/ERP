...
<html>
  <head>
    <meta charset="utf-8">
    <title>Sanction Details Show</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Sanction Details</span></a>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="field-show mb-3 col-sm-4">
                    ...
                    <div class="field-show mb-3  col-sm-4">
                    <div class="label">
                    <h6 class="title">Sanction Amount</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['san_amount'] ?></span> 
                    </div>
                    </div>
