...
<html>
  <head>
    <meta charset="utf-8">
    <title>Stock Audit Details View</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Stock Audit Details</span></a>
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="field-show mb-3 col-sm-6">
                    ...
                    <div class="form-control view-form">  
                      <span><?php echo $row['start_yr'] ?></span>-<span><?php echo $row['end_yr'] ?></span>
                    </div>
                    </div>
                ...
                <div class="row row-border">
                  ...
                  <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Audior Name</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['audit1_name'] ?></span>
                    </div>
                    </div>
                    
                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Audior Address</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['audit1_addr'] ?></span>
                    </div>
                    </div>

                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Audior Contact No</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['audit1_no'] ?></span>
                    </div>
                    </div>
          ...
          ?>
                    <div class="form-group col-md-4 field-show-image">
                      <div class="image-upload">  
                        <div class="label">
                        <h6 class="title">Auditor 1 Document File <?= $key+1 ?></h6>
...
?>                        
 ...
 <div class="row row-border"> 
                  ...
                  <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Auditor Name</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['audit2_name'] ?></span>
                    </div>
                    </div>
                    ...
                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Auditor Address</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['audit2_addr'] ?></span>
                    </div>
                    </div>
                    ...
                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Auditor Contact No</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['audit2_no'] ?></span>
                    </div>
                    </div>
        ...
        if(in_array($attendExt, $attend_allowExt)) 
        {
          ...
          ?>
                    <div class="form-group col-md-4 field-show-image">
                      <div class="image-upload">  
                        <div class="label">
                        <h6 class="title">Auditor 2 Document File <?= $key+1 ?></h6>
