...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if (isset($_POST['Submit'])) {
    ...
    $timestamp=date("Y-m-d H:i:s");
		...
		if(!isset($errorMsg)){
			$sql = "insert into broker(name, contact, address, gstin,pan_no,doc_file,img_title,username,created_at,updated_at)
					values('".$name."', '".$contact."', '".$address."', '".$gstin."', '".$pan_no."', '".$imgStore."', '".$imgTitle."', '".$username."', '".$timestamp."', '".$timestamp."')";
