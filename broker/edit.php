...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "select * from broker where id=".$id;
  ...
  $data=getStaticFileStoragePath("broker");  //from global_function.php
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Edit Broker</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <?php
          $sqlLastChange="select username,updated_at from broker where id='".$row['id']."'";
                ...
                <form class="" action="" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input type="text" class="form-control" name="contact" placeholder="Enter Contact Number" value="<?php echo $row['contact']; ?>">
                    </div>
                    <div class="form-group col-sm-4">
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input id="gst_in" type="text" class="form-control" name="gstin" placeholder="Enter GST" value="<?php echo $row['gstin']; ?>" onkeypress="return GSTValidationKeyup(event)" maxlength="15">
                    </div>

                     <div class="form-group col-sm-4">
                      <label for="pan_no">PAN No.</label>
                      <input type="text" class="form-control" name="pan_no" placeholder="Enter PAN No." onchange="validatePanNumber(this)" style="text-transform:uppercase" onkeypress="return panValidationKeyup(event)" maxlength="10" minlength="10" id="pan_no" value="<?php echo $row['pan_no']; ?>">
                    </div>
