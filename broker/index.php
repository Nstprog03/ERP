  ...
  if(isset($_GET['delete'])){
    ...
    $getFiles = explode(',', $row['doc_file']); 
      foreach ($getFiles as  $item) 
      {
		...
		$sql = "delete from broker where id=".$id;
...
{
  unset ($_SESSION["brok_filter_data"]);
  unset ($_SESSION["brok_filter_selected"]);
  ...
  $isFilter=false;
  $selectedArr=array();
  if (isset($_POST['filter']) || isset($_SESSION['brok_filter_data'])) 
  {

    $isFilter=true;

    $main_query="select * from broker where";
    $where_cond = array();
    ...
    if(isset($_POST['filter']))
    {
      ...
      if(isset($_POST['broker']))
      {
        ...
        $where_cond[] = " id in (".$broker.")";
      }

      $selectedArr=$_POST;
      $_SESSION['brok_filter_selected']=$selectedArr;
      $_SESSION['brok_filter_data']=$where_cond;
    }
    else
    {
      $where_cond=$_SESSION['brok_filter_data'];
      $selectedArr=$_SESSION['brok_filter_selected'];
    }
     ...
     $main_query = $main_query.$where;
      ...
      $_POST = array();
       //pagination  ------------------
        ...
        $sql = "select * from broker ORDER BY id DESC LIMIT $start_from, $per_page_record";     
        $result = mysqli_query($conn, $sql);
        }
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          ...
          <?php
          $sqlLastChange="select username,updated_at from broker order by updated_at DESC LIMIT 1";
        ...
        <div class="row justify-content-center">
           ...
           <div class="card viewfilter">
              <div class="card-header">Filter</div>
                ...
                <div class="card mt-3">
                    <div class="card-header">Broker List</div>
                      <div class="card-body">
                    ...
                    <?php if (!isset($_SESSION['brok_filter_data'])) 
                    {
