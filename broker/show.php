...
<html>
  <head>
    <meta charset="utf-8">
    <title>View Broker Details</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Show Broker Details</span></a>
            ...
            <div class="card-body">
                ...
                <div class="col-md">
                  <div class="row">
                    ...
                    <div class="field-show mb-3 col-sm-6">
                    <div class="label">
                    <h6 class="title">GSTIN</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['gstin'] ?></span>
                    </div>
                    </div>
                    ...
                    <div class="form-control view-form">  
                      <span style="text-transform:uppercase"><?php echo $row['pan_no'] ?></span>
                    </div>
                    </div>
                  </div>
