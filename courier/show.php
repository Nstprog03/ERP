    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> View Courier Details</span></a>
                ...
                <div class="col-md">
                  <div class="row">
                    ...
                    <h6 class="title">Party Name</h6>
                     ...
                     <div class="form-control view-form">  
                      <span><?php echo $row2['partyname'] ?></span>
                    </div>
                    </div>
                    ...
                    <div class="field-show mb-3 col-sm-3">
                    <div class="label">
                    <h6 class="title">Send Date</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo  $send_date; ?></span>
                    </div>
                    </div>

                    <div class="field-show mb-3 col-sm-3">
                    <div class="label">
                    <h6 class="title">Docket Type</h6>
                    </div>
                    <div class="form-control view-form">  
                       <span><?php echo $row['docket_type'] ?></span></span>
                    </div>
                    </div>

                    <div class="field-show mb-3 col-sm-3">
                    <div class="label">
                    <h6 class="title">Docket No</h6>
                    </div>
                    <div class="form-control view-form">  
                       <span><?php echo $row['docket_no'] ?></span></span>
                    </div>
                    </div>
                    ...
                    ?>
                      ...
                      <div class="field-show mb-3 col-sm-3">
                    <div class="label">
                    <h6 class="title">Recevied Date</h6>
                    </div>
                    <div class="form-control view-form">  
                       <span><?php echo $rcvdDate; ?></span></span>
                    </div>
                    </div>
                  </div>
