...
<html>
  <head>
    <meta charset="utf-8">
    <title>  Documentation Details</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
           <a class="navbar-brand" href="home.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Documentation Details</span></a>
          ...
          ?>
              ...
              <ul class="navbar-nav ml-auto"><a class="btn btn-outline-danger" href="home.php?page=<?php echo $page ?>"><i class="fa fa-sign-out-alt"></i><span>Back</span></a>
              </ul>
