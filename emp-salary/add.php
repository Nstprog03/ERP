...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  $imgArr=array();
    ...
    $timestamp=date("Y-m-d H:i:s");
		...
		if(!isset($errorMsg)){
			$sql = "insert into emp_salary(firm, financial_year, mnt,docimg,img_title,username,created_at,updated_at)
					values('".$firm."', '".$financial_year."', '".$mnt."', '".$imgStore."', '".$imgTitle."', '".$username."', '".$timestamp."', '".$timestamp."')";
