...
<html>
  <head>
    <meta charset="utf-8">
    <title>Employee Salary Database Create</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Create New Employee Salary Database</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Employee Salary Database</div>
              <div class="card-body">
                  ...
                  <div class="row"> 
                    ...
                    <div class="form-group col-md-4">
                      ...
                      foreach ($financialYear as $result3) 
                      {
                        ...
                        $curDate=date('Y-m-d');
                        $startdate=date('Y-m-d', strtotime($result3['startdate']));
                        $enddate=date('Y-m-d', strtotime($result3['enddate']));
                    ...
                    <select name="mnt" class="form-control" id="month">
