    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Employee Salary Details</span></a>
                ...
                <div class="col-md">
                    ...
                    <h5 class="form-control">
                      ...
                      <?php
                            ...
                            ?>
                      <span><?php echo $financial_year; ?></span>
                    </h5>
