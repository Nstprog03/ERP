...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if(isset($_GET['delete'])){
		...
		$sql = "delete from external_banks where id=".$id;
  ...
  if(isset($_POST['btn_multi_del']))
  {
    ...
    $sql = "SELECT * FROM external_banks ORDER BY id DESC LIMIT $start_from, $per_page_record";     
    $result = mysqli_query($conn, $sql);
...
<html>
  <head>
    <meta charset="utf-8">
    <title>External Party Banks List</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> External Party Bank Database</span></a>
       ...
       <!-- last change on table START-->
          <?php
          $sqlLastChange="select username,updated_at from external_banks order by updated_at DESC LIMIT 1";
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
                ...
                <div class="card">
                    <div class="card-header">External Party Banks List</div>
                      <div class="card-body">
                      ...
                      <table id="example" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                               <?php if($_SESSION['user_type']=='master') { ?>     
                                ...
                                <th>Branch Person Contact Number</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                           ...
                           <td><?php echo $row['branch_person'] ?></td>
                    ...
                    <?php
                      $query = "SELECT COUNT(*) FROM external_banks";     
