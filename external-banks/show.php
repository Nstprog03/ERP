...
<html>
  <head>
    <meta charset="utf-8">
    <title>External Party Bank Details</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> External Party Bank Details</span></a>
            ...
            <div class="card-body">
              <form class="" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="bank_branch" value="<?php echo $row['bank_branch']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="branch_person">Bank Branch Contact Person</label>
                      <input type="text" class="form-control" name="branch_person"  value="<?php echo $row['branch_person']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="branch_no">Bank Branch Contact Person</label>
                      <input type="text" class="form-control" name="branch_no"  value="<?php echo $row['branch_no']; ?>">
                    </div>
