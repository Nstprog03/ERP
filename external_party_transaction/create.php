...
<html>
  <head>
    <meta charset="utf-8">
    <title>External Party Hundi Transation Create</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Crete New External Party Hundi Transaction</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Create External Party Hundi Transaction</div>
              <div class="card-body">
                <form class="" action="add.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-md-4">
                    <label for="party">Select Firm</label>
                    <?php
                          ...
                          ?>                      
                           <select name="bank" class="form-control">
                            <?php                   
                              foreach ($conn->query($sql) as $result) 
                              {
                                    echo "<option  value='".$result['id']."'>" .$result['bank_name']. "</option>";
                              }
                            ?>                              
                            </select>
                    </div>
