...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "select e.*,f.party_name as firm_name from external_party_transaction e, party f where e.firm=f.id AND e.id=".$id;
...
<html>
  <head>
    <meta charset="utf-8">
    <title>External Party Hundi Transation Details</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> External Party Hundi Transation Details</span></a>
          ...
          <div class="card">
            ...
            <div class="card-body">
             ...
             <div class="form-group col-md-4">
                ...
                <input class="form-control" type="text" value="<?php echo $firm; ?>" readonly>                              
            </div>
                    ...
                    <label for="party">External Party</label>
                     <input class="form-control" type="text" value="<?php echo $partyname; ?>" readonly>
                   
                  </div>

                    <?php
                      $sql2 = "select * from external_banks where id='".$row['bank']."'";
                      $result2 = mysqli_query($conn, $sql2);
                      $bank='';
                      if(mysqli_num_rows($result2)>0)
                      {
                    ...
                    <div class="form-group col-md-4">
                     ...
                     <input class="form-control" type="text" value="<?php echo $bank; ?>" readonly>
                    </div>
                  ...
                  ?>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input class="form-control datepicker" type="text" name="start_date"  autocomplete="off" value="<?php echo $start_date; ?>" readonly>
                    </div>

                      <div class="form-group col-md-4">
                      <label for="end_date">End Date</label>
                      <input class="form-control datepicker" type="text" name="end_date" autocomplete="off" value="<?php echo $end_date; ?>" readonly>
                    </div>

                    </div>

        <div class="row" style="margin-left: 0px !important;margin-right: 13px !important;">
