...
<html>
  <head>
    <meta charset="utf-8">
    <title>Create Insurance Report</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
         <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span>  Create New Insurance Database</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Create Insurance Report</div>
              <div class="card-body">
                ...
                <form class="" action="add.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input type="text" class="form-control" name="policyno"  placeholder="Enter Policy No" value="">
                    </div>

                  <div class="form-group col-sm-4">
                      <label for="comp_name">Company Name</label>
                      <input type="text" class="form-control" name="comp_name"  placeholder="Enter Company Name" value="">
                    </div>

              <div class="form-group col-sm-4">
                      <label for="ins_type">Insurance Type</label>
                    <select select="selected" name="ins_type" class="form-control">
                      <option value="Plant & Machinary & Building">Plant & Machinary & Building</option>
                      <option value="Stock">Stock</option>
                      <option value="Worker Policy">Worker Policy</option>
                      <option value="House Policy">House Policy</option>
                      <option value="Equipment Policy">Equipment Policy</option>
                  ...
                  <div class="form-group col-sm-4">
                      <label for="vehicle_no">Vehicle/Machine No</label>
                       <input type="text" class="form-control" name="vehicle_no"  placeholder="Enter Vehicle No" value="">
                  </div>
                
                      <div class="form-group col-sm-4">
                      <label for="start_date">Start Date</label>
                      <input id="start_date" class="form-control datepicker" type="text" name="start_date" autocomplete="off" placeholder="Start Date">
                    </div>
                   ...
                   <div class="form-group col-sm-4">
                      ...
                      <input id="end_date" class="form-control datepicker" type="text" name="end_date" autocomplete="off" placeholder="End Date" onchange="datechekcer()">
                    </div>

                
                   <div class="form-group col-sm-4">
                      <label for="sum_ass">Sum Assured</label>
                       <input type="text" class="form-control" name="sum_ass"  placeholder="Enter Sum Assured Amount" value="">
                  </div>
                  <div class="form-group col-sm-4">
...
var diff = new Date(end - start);
    ...
    var fDate = new Date(start);
    var lDate = new Date(end);
    if(fDate < lDate) {
    ...
    {
    $('#end_date').each( function resetDate(){
