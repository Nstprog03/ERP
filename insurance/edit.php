...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  $dir = "/static_file_storage/"; // file storage in root folder of site
...
<html>
  <head>
    <meta charset="utf-8">
    <title>Edit Insurance Report</title>
 ...
 <div class="wrapper">
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
         <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Edit Insurance Report</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          ?>
           ...
           <?php
          $sqlLastChange="select username,updated_at from insurance where id='".$row['id']."'";
              ...
              <div class="card-body">
                ...
                ?>                             
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input type="text" class="form-control" name="policyno"  placeholder="Enter Policy No" value="<?php echo $row['policyno']; ?>">
                    </div>
                    <div class="form-group col-sm-4">
                      <label for="comp_name">Company Name</label>
                      <input type="text" class="form-control" name="comp_name" placeholder="Enter Company Name" value="<?php echo $row['comp_name']; ?>">
                    </div>


                     <div class="form-group col-sm-4">
                      <label for="ins_type">Insurance Type</label>
                    <select select="selected" name="ins_type" class="form-control">

                      <?php
                       $typeArr=['Plant & Machinary & Building','Stock','Worker Policy','House Policy','Equipment Policy','Car','Bike','Transit Insurance'];

                        foreach($typeArr as $item)
                        {

                          if($row['ins_type']==$item)
                          {
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input type="text" class="form-control" name="vehicle_no" placeholder="Enter Vehicle No" value="<?php echo $row['vehicle_no']; ?>">
                    </div>
                  ...
                  ?>
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input class="form-control datepicker" type="text" autocomplete="off" name="start_date" placeholder="Start Date" value="<?php echo $start_date; ?>">
                    </div>

                      <div class="form-group col-sm-4">
                      <label for="end_date">End Date</label>
                      <input class="form-control datepicker" type="text" autocomplete="off" name="end_date" placeholder="End Date" value="<?php echo $end_date; ?>">
                    </div>
                   </div>
                   ...
                   <div class="row">
                      ...
                      <div class="form-group col-sm-4">
                      <label for="sum_ass">Sum Assured</label>
                      <input type="text" class="form-control" name="sum_ass" placeholder="Enter Sum Assured" value="<?php echo $row['sum_ass']; ?>">
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                        <label for="status">Status</label>
                         ...
                         <select name="status" class="form-control">
                          ...
                          <option value="2" <?php if($row['status'] == '2') { echo "selected"; } ?>>Renewed</option> 
