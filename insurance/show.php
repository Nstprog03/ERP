...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "select i.*,p.party_name from insurance i,party p where i.firm_id=p.id AND i.id=".$id;
...
<html>
  <head>
    <meta charset="utf-8">
    <title>View Insurance Report Details</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
             <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Insurance Report Details</span></a>
              ...
              <div class="row">
                ...
                <div class="col-md">
                  <div class="row">
                    ...
                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Policy No</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['policyno'] ?></span>
                    </div>
                    </div>
                    ...
                    <h6 class="title">Company Name</h6>
                     ...
                     <div class="form-control view-form">  
                      <span><?php echo $row['comp_name'] ?></span>
                    </div>
                    </div>

                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Insurance Type</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['ins_type'] ?></span>
                    </div>
                    </div>

                     <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Vehicle No</h6>
                    </div>
                    <div class="form-control view-form">  
                    ...
                    <div class="field-show mb-3 col-sm-4">
                    <div class="label">
                    <h6 class="title">Sum Assured</h6>
                    </div>
                    <div class="form-control view-form">  
                      <span><?php echo $row['sum_ass'] ?></span>
                    </div>
                    </div>
                </div>
