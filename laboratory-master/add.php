...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if (isset($_POST['Submit'])) {
    ...
    $timestamp=date("Y-m-d H:i:s");
		...
		if(!isset($errorMsg)){
			$sql = "insert into laboratory_master(lab_name, gst_no, address, city, contact_no, bank_name, bank_ifsc, account_no, branch, doc_file,img_title,pan_no,username,created_at,updated_at)
					values('".$lab_name."', '".$gst_no."', '".$address."', '".$city."', '".$contact_no."', '".$bank_name."', '".$bank_ifsc."', '".$account_no."', '".$branch."', '".$imgStore."', '".$imgTitle."', '".$pan_no."', '".$username."', '".$timestamp."', '".$timestamp."')";
