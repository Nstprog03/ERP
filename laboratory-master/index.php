...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if(isset($_GET['delete'])){
    ...
    if(mysqli_num_rows($result) > 0){
      ...
      $sql = "delete from laboratory_master where id=".$id;
  ...
  if(isset($_POST['btn_multi_del']))
  {
   ...
   //pagination  ------------------
    ...
    $sql = "SELECT * FROM laboratory_master ORDER BY id DESC LIMIT $start_from, $per_page_record";     
    $result = mysqli_query($conn, $sql);
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Laboratory Master</span></a>
       ...
       <!-- last change on table START-->
          <?php
          $sqlLastChange="select username,updated_at from laboratory_master order by updated_at DESC LIMIT 1";
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
                ...
                <div class="card">
                    <div class="card-header">Laboratory Master</div>
                      <div class="card-body">
                    ...
                    <?php
                      $query = "SELECT COUNT(*) FROM laboratory_master";     
