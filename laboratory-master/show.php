    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Laboratory Master Details</span></a>
        ...
        <div class="row justify-content-center">
          <div class="card">
            <div class="card-header">
              Laboratory Master Details
            </div>
            <div class="card-body">
              <div class="row">
                <div class="field-show mb-3 col-md-4">
                  <div class="label">
                    <h6 class="title">Lab Name</h6>
                  </div>
                  <div class="form-control view-form">  
                    <span><?php echo $row['lab_name'] ?></span>
                  </div>
                </div>

                <div class="field-show mb-3 col-md-4">
                  <div class="label">
                    <h6 class="title">GST No</h6>
                  </div>
                  <div class="form-control view-form">  
              ...
              <div class="row">
                <div class="field-show mb-3 col-sm-6">
                  <div class="label">
                    <h6 class="title">Account No</h6>
                  </div>
                  <div class="form-control view-form">  
                    <span><?php echo $row['account_no'] ?></span>
                  </div>
                </div>
