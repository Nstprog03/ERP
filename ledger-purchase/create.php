...
<html>
  <head>
    <meta charset="utf-8">
    <title>External Party Ledger Purchase</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> External Party Ledger Purchase</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Create External Party Ledger Purchase</div>
              <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-sm-4">
                      ...
                      <?php
                          ...
                          ?>                      
                           <select name="party" data-live-search="true" class="form-control searchDropdown" required>
                           <option value="" selected="" disabled="">Select Option</option>
                    ...
                    <div class=" form-group  col-sm-4 imgcount dynamic_field_1">
                      <label class="image-label" for="ledger">Document File 1</label>
                        <div class="image-upload dynamic_field">
                          ...
                          <input type="file" class="form-control" id="img1" onchange="readURL(this);" name="ledger[]" value="">
                          <br>
