...
<html>
  <head>
    <meta charset="utf-8">
    <title>Edit External Party Ledger Purchase</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Edit External Party Ledger Purchase</span></a>
      ...
      <!-- last change on Record START-->
          <?php
          $sqlLastChange="select username,updated_at from pur_ledger where id='".$row['id']."'";
