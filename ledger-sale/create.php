...
<html>
  <head>
    <meta charset="utf-8">
    <title>External Party Ledger Sales Create</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Create New External Party Ledger Sales</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="card">
              <div class="card-header">Create External Party Ledger Sales</div>
              <div class="card-body">
