...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  $data=getFileStoragePath("ledger_sales",$_POST['financial_year']);  //this function called from global_function.php file
  ...
  $store_path=$data[1]; // db store path
   ...
   $username= $_SESSION["username"];
    ...
    $imgArr=array();
    $filecount = count($_FILES['ledger']['tmp_name']);  
...
<html>
  <head>
    <meta charset="utf-8">
    <title>Edit Sales Ledger Report</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Edit Sales Ledger Report</span></a>
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <?php
                          ...
                          ?>
                           ...
                           <select name="party" data-live-search="true" class="form-control searchDropdown">
                           
                            
                            <?php                   
                                foreach ($conn->query($sql) as $result) {

                                    if($result['id']==$row['party'])
                                    {
...
{ ?>
      ...
      <div class=" form-group  col-sm-4 imgcount dynamic_field_<?= $key+1 ?>">
        <label class="image-label" for="ledger">Document File <?= $key+1 ?></label>
          <div class="image-upload dynamic_field">
            ...
            <input type="file" class="form-control" id="img<?= $key+1 ?>" onchange="readURL(this);" name="ledger[<?= $key?>]" value="">
...
<div class=" form-group  col-sm-4 imgcount dynamic_field_1">
    <label class="image-label" for="ledger">Document File 1</label>
      <div class="image-upload dynamic_field">
        ...
        <input type="file" class="form-control" id="img1" onchange="readURL(this);" name="ledger[1]" value="">
        <br>
...
<?php }?>
  ...
  <div class="form-group form-group col-sm-4">
    <label class="image-label" for="ledger">Add more</label>
