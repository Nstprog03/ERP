...
<html>
  <head>
    <meta charset="utf-8">
    <title>Other Payout Create</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Other Payout Create</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Other Payout Create</div>
              <div class="card-body">
                  ...
                  <div class="form-group col-md-4">
                   ...
                   <div class="col-md-4">
                    ...
                    <label class="radio-inline">
                      <input type="radio" name="pay_to" value="e" checked> External Party
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="pay_to" value="b"> Broker
                    </label> 
                  </div>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control" name="invoice_no"  placeholder="Enter Invoice No" value="">
                   </div>

                   <div class="form-group col-md-4">
                      <label for="amount">Amount</label>
                      <input type="text" class="form-control" name="amount"  placeholder="Enter Amount" value="" onkeypress="return NumericValidate(event,this)" value="">
                   </div>


                   <div class="form-group col-md-4">
                      <label for="remark">Remark</label>
                      <textarea class="form-control" name="remark" rows="4" placeholder="Enter Remark"></textarea>
                   </div>
