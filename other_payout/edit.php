  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Other Payout Edit</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Other Payout Edit</div>
              <div class="card-body">
                <form class="" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <label class="radio-inline">
                      <input type="radio" name="pay_to" value="e" <?php if($row['pay_to']=='e'){ echo 'checked';} ?>> External Party
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="pay_to" value="b" <?php if($row['pay_to']=='b'){ echo 'checked';} ?>> Broker
                    </label> 
                  </div>
                    ...
                    <div class="form-group col-md-4 extSection">
                      ...
                      <?php
                          ...
                          ?>                      
                           <select name="ext_party_id" data-live-search="true" class="form-control searchDropdown">
                       ...
                       <div class="form-group col-md-4 brokSection">
                      ...
                      <?php
                          ...
                          ?>                      
                           <select name="broker_id" data-live-search="true" class="form-control searchDropdown">
                            <option value="" selected="" disabled="">Select Option</option>
                            <?php                   
                              foreach ($conn->query($sql) as $result) 
                              {
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control" name="invoice_no"  placeholder="Enter Invoice No" value="<?php echo $row['invoice_no'] ?>" >
                   </div>

                   <div class="form-group col-md-4">
                      <label for="amount">Amount</label>
                      <input type="text" class="form-control" name="amount"  placeholder="Enter Amount" onkeypress="return NumericValidate(event,this)" value="<?php echo $row['amount'] ?>">
                   </div>


                   <div class="form-group col-md-4">
                      <label for="remark">Remark</label>
                      <textarea class="form-control" name="remark" rows="4" placeholder="Enter Remark"><?php echo $row['remark'] ?></textarea>
                   </div>
    ...
    <script type="text/javascript">
      ...
      var delCount=0;
        ...
        $(document).ready(function () {
               ...
               // pay to
            var getRadioVal=$('input[type=radio][name=pay_to]:checked').val();
            if(getRadioVal=='e')
            {
              $('.extSection').show();
              $('.brokSection').hide();
