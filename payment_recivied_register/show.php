                ...
                <form class=""  method="POST"
                   ...
                   <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <div class="row">
                       <?php
                        ...
                        <div class="form-group col-sm-4">
                          ...
                          <input type="text" class="form-control" value="<?php  
                              ...
                              $Ex_party = "select * from external_party where id='".$row['pur_party']."'";
                        ...
                        <div class="form-group col-sm-4">
                         ...
                         <?php
                            ...
                            if($row['received_date']!='' && $row['received_date']!='0000-00-00')
                             {
                                $rcvd_date=date('d/m/Y', strtotime($row['received_date']));
                             }
                            ?>

                        <div class="form-group col-sm-4">
                          <label for="lot_bales">Recevied Date</label>
                          <div id="bales">
                          
                            <input type="text"  class="form-control mb-2 lot_bales" name="lot_bales[]" value="<?php echo $rcvd_date;?>" readonly>
                      ...
                      <div class="form-group col-sm-4">
                          <label for="lot_bales">Outstanding amount</label>
                          <div id="bales">
