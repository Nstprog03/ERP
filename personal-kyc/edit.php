  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Edit Personal KYC</span></a>
      ...
      <!-- last change on Record START-->
          <?php
          $sqlLastChange="select username,updated_at from personal_kyc where id='".$row['id']."'";
                ...
                <form class="" action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="form-group col-sm-4">
                      ...
                      <input type="text" class="form-control" name="firstname"  placeholder="Enter Name" value="<?php echo $row['firstname']; ?>">
                    </div>        

                    <div class="form-group col-sm-4">
                      <label for="lastname">Last Name</label>
                      <input type="text" class="form-control" name="lastname"  placeholder="Enter Name" value="<?php echo $row['lastname']; ?>">
                    </div>              

                    <div class="form-group col-sm-4">
                      <label for="mobile">Mobile</label>
                      <input type="text" class="form-control" name="mobile"  placeholder="Enter Name" value="<?php echo $row['mobile']; ?>">
                    </div>                

                    <div class="form-group col-sm-4">
                      <label for="designation">Designation</label>
                      <input type="text" class="form-control" name="designation"  placeholder="Enter Name" value="<?php echo $row['designation']; ?>">
                    </div>     

                    <div class="form-group col-sm-4">
                      <label for="address">Address</label>
                      <input type="text" class="form-control" name="address"  placeholder="Enter Name" value="<?php echo $row['address']; ?>">
                    </div>   
