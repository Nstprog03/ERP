...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if(isset($_GET['delete'])){
    ...
    $sql2="delete from product_sub_items where product_id=".$id;
    ...
    $sql = "SELECT * FROM products  order by id DESC LIMIT $start_from, $per_page_record";     
    $result = mysqli_query($conn, $sql);
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Products Database</span></a>
       ...
       <!-- last change on table START-->
          <?php
          $sqlLastChange="select username,updated_at from products order by updated_at DESC LIMIT 1";
