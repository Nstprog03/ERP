...
<body>
    ...
    $user=$_SESSION['username'];
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="fa fa-cog text-danger" aria-hidden="true"></i></a>
                            </li>
                            <li class="nav-item">
                                   <a class="nav-link" href="logout.php"><i class="fas fa-power-off text-danger" aria-hidden="true"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container">
          <div class="row">
         <div class="reset-wrapper col-sm-6 m-auto">
