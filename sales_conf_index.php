...
<html>
  <head>
    <meta charset="utf-8">
    <title>Sales Confirmation Dashboard</title>
...
if(isset($_POST['submit'])){
  ...
  $_SESSION["sales_conf_firm"] = $firmDetails[0];
  $_SESSION["sales_conf_firm_id"] = $firmDetails[1];


  $_SESSION["sales_conf_financial_year"] = $_POST['financial_year'];
  ...
  $_SESSION["sales_financial_year_id"] = $row3['id'];
...
?>
      ...
      <div id="sidebarnav"></div>
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><span class="page-name-top"><span class="icon-report_dashboard"></span> Sales Dashboard</span></a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a class="btn btn-outline-danger" href="/sales_conf_index.php"><i class="fa fa-sign-out-alt"></i>Back</a></li>
            </ul>
        ...
        <!-- Page Content  -->
          ...
          <div class="col-md-7">
            <div class="card">
              <div class="card-header">Sales Pre-Selection</div>
 <div class="card-body">
...
<div class="container">
            <div class="form-group select-pages">

                <!--<label for="select_page_group">Select page:</label>-->
               ...
               <ul>
                    ...
                    <li>
                        ...
                        Sales Confirmation</a>
                    </li>     

                    <li>
                        <a href="/sales_conf_split">
<span class="inital"><span class="icon-ledger"></span></span>
                        Confirmation Split</a>
                    </li>
