...

{
    ...
    $sql2 = "select * from seasonal_year where id='".$row['seasonal_year_id']."'";
...

{
  ...
  $timestamp=date("Y-m-d H:i:s");
   ...
   $sql_pdf="insert into pdf_kapasiya (table_indicator,record_id,file_name,username,created_at) value('0','".$_GET['id']."','".$filename."','".$_SESSION['username']."','".$timestamp."')";
