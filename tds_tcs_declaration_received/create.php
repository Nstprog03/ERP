...
<html>
  <head>
    <meta charset="utf-8">
    <title>Create New TDS/TCS Declaration Received</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> TDS/TCS Declaration Received</span></a>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="card">
              <div class="card-header">Create New TDS/TCS Declaration Received</div>
              <div class="card-body">
