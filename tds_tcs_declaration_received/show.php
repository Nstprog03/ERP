...
<html>
  <head>
    <meta charset="utf-8">
    <title>View TDS/TCS Declaration Received</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Show TDS/TCS Declaration Received</span></a>
        ...
        <div class="row justify-content-center">
          <div class="card">
            <div class="card-header">
              View TDS/TCS Declaration Received
            </div>
            <div class="card-body">
         ...
         <div class="form-group col-md-4">
                ...
                <label for="financial_year_id">Financial Year</label>
                 ...
                 <select name="financial_year_id" class="form-control" disabled="">
                ...
                ?>                              
                    ...
                    <?php
                      ...
                      $result = mysqli_query($conn, $sql);
                    ?>                       
                    <select data-live-search="true" class="form-control searchDropdown" name="ext_party_id" disabled="">
                      <?php                   
                        foreach ($conn->query($sql) as $result) 
                        {
