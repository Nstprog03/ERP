  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php?module=<?= $module ?>"><span class="page-name-top"><span class="icon-report_dashboard"></span> TDS/TCS Declaration Show</span></a>
                  ...
                  <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <?php
                                       ...
                                       $result = mysqli_query($conn, $sql);
                                       ?>                      
                                    <select name="firm" class="form-control" disabled="">
                                    <?php                   
                              ...
                              <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <?php
                                       ...
                                       ?>                     
                                    <select name="financial_year" class="form-control" disabled="">
                                    <?php                   
                                       rsort($storeDates);
                    ...
                    <div class="form-group col-md-4">
                      <label for="status">Turnover</label>                  
                      <input type="text" name="good_exceeding" class="form-control" value="<?php echo $row['turnover'] ?>" readonly>
                    </div>
