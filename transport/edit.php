...
<html>
  <head>
    <meta charset="utf-8">
    <title>Transport Details Edit </title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Edit Transport Details</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <?php
          $sqlLastChange="select username,updated_at from transport where id='".$row['id']."'";
...
<div class="row">
                    <div class="form-group col-sm-4">
                      ...
                      <input type="text" class="form-control" name="trans_name"  placeholder="Enter Name" value="<?php echo $row['trans_name']; ?>">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="trans_addr">Transport Address</label>
                      <input type="text" class="form-control" name="trans_addr"  placeholder="Enter Name" value="<?php echo $row['trans_addr']; ?>">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="trans_ow_name">Transport Owner Name</label>
                      <input type="text" class="form-control" name="trans_ow_name"  placeholder="Enter Name" value="<?php echo $row['trans_ow_name']; ?>">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="gst_no">GST No</label>
                      <input id="gst_in" type="text" class="form-control" name="gst_no"  placeholder="Enter Name" value="<?php echo $row['gst_no']; ?>" onkeypress="return GSTValidationKeyup(event)" maxlength="15">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="pan_no">PAN Number</label>
                      <input type="text" class="form-control" name="pan_no"  placeholder="Enter Name" value="<?php echo $row['pan_no']; ?>" id="pan_no" onchange="validatePanNumber(this)" style="text-transform:uppercase" maxlength="10" minlength="10" onkeypress="return panValidationKeyup(event)">
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                      ...
                      <input type="text" class="form-control" name="bank_branch"  placeholder="Enter Name" value="<?php echo $row['bank_branch']; ?>">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="bank_no">Bank A/C Number</label>
                      <input type="text" class="form-control" name="bank_no"  placeholder="Enter Name" value="<?php echo $row['bank_no']; ?>">
                    </div>

                    <div class="form-group col-sm-4">
                      <label for="bank_ifsc">IFSC Code</label>
                      <input type="text" class="form-control" name="bank_ifsc"  placeholder="Enter Name" onkeypress="return IFSCValidation(event)" id="ifsc" maxlength="11" value="<?php echo $row['bank_ifsc']; ?>">
                    </div>
                </div>
                      ...
                      $attend =  $dir.$imging;
                    {
                      ...
                      { ?>
                        ...
                        <div class=" form-group  col-sm-4 pl-0 imgcount dynamic_field_<?= $key+1 ?>">
                          <label class="image-label" for="file">Document File <?= $key+1 ?></label>
                            <div class="image-upload dynamic_field">
                              ...
                              <input type="file" class="form-control" id="img<?= $key+1 ?>" onchange="readURL(this);" name="file[<?= $key?>]" value="">
                ...
                <div class=" form-group  col-sm-4 pl-0 imgcount dynamic_field_1">
                      <label class="image-label" for="file">Document File 1</label>
                        <div class="image-upload dynamic_field">
                          ...
                          <input type="file" class="form-control" id="img1" onchange="readURL(this);" name="file[1]" value="">
                          <br>
