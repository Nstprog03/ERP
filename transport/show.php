...
<html>
  <head>
    <meta charset="utf-8">
    <title>Transport Details View</title>
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Transport Details View</span></a>
...
<div class="label">
<h6 class="title">Transport Name</h6>
</div>
<div class="form-control view-form">  
<span><?php echo $row['trans_name'] ?></span>
</div>
</div>
...
<div class="field-show mb-3 col-sm-4">
<div class="label">
<h6 class="title">Transport Address</h6>
</div>
<div class="form-control view-form">  
<span><?php echo $row['trans_addr'] ?></span>
</div>
</div>

<div class="field-show mb-3 col-sm-4">
<div class="label">
<h6 class="title">Transport Owner Name</h6>
</div>
<div class="form-control view-form">  
<span><?php echo $row['trans_ow_name'] ?></span>
</div>
</div>

<div class="field-show mb-3 col-sm-4">
<div class="label">
<h6 class="title">Transport GST No</h6>
</div>
<div class="form-control view-form">  
<span><?php echo $row['gst_no']; ?></span>
</div>
</div>

<div class="field-show mb-3 col-sm-4">
<div class="label">
<h6 class="title">PAN No</h6>
</div>
<div class="form-control view-form">  
<span><?php echo $row['pan_no']; ?></span>
</div>
</div>
...
<div class="field-show mb-3 col-sm-4">
<div class="label">
<h6 class="title">Bank Account Number</h6>
</div>
<div class="form-control view-form">  
<span><?php echo $row['bank_no']; ?></span>
</div>
</div>

<div class="field-show mb-3 col-sm-4">
<div class="label">
<h6 class="title">Bank IFSC</h6>
</div>
<div class="form-control view-form">  
<span><?php echo $row['bank_ifsc']; ?></span>
</div>
</div>
