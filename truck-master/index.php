...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
  ...
  if(isset($_GET['delete'])){
    ...
    if(mysqli_num_rows($result) > 0){
      ...
      $sql = "delete from truck_master where id=".$id;
...
{
  unset ($_SESSION["truck_filter_data"]);
  unset ($_SESSION["truck_filter_selected"]);
  header("location:index.php");
}

  $isFilter=false;
  $selectedArr=array();
  if (isset($_POST['filter']) || isset($_SESSION['truck_filter_data'])) 
  {

    $isFilter=true;
    $main_query="select * from truck_master where";
    $where_cond = array();
    ...
    if(isset($_POST['filter']))
    {
        ...
        if(isset($_POST['transport']))
        {
          ...
          $where_cond[] = " transport in (".$transport.")";
        }
          $selectedArr=$_POST;
          $_SESSION['truck_filter_selected']=$selectedArr;
          $_SESSION['truck_filter_data']=$where_cond;
    }
    else
    {
      $where_cond=$_SESSION['truck_filter_data'];
      $selectedArr=$_SESSION['truck_filter_selected'];
    }
    ...
    else
    {
      $_POST = array();
       //pagination  ------------------
        ...
        $sql = "SELECT * FROM truck_master ORDER BY id DESC LIMIT $start_from, $per_page_record";     
        $result = mysqli_query($conn, $sql);
        }
    ...
    <div class="wrapper">
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php"><span class="page-name-top"><span class="icon-report_dashboard"></span> Truck Master</span></a>
       ...
       <!-- last change on table START-->
          <?php
          $sqlLastChange="select username,updated_at from truck_master order by updated_at DESC LIMIT 1";
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          ...
          <div class="card viewfilter">
                      ...
                      <div class="row">
                        <div class="form-group col-sm-6">
                          <div class="form-group">
                            <label for="firm">Select Tansport</label>
                                <?php
                                      $sql_transport = "select * from transport";
                                      $result_transport = mysqli_query($conn, $sql_transport);
                                      
                                    ?>                      
                                 <select name="transport[]" data-live-search="true" class="form-control searchDropdown" title="Select" multiple="">
                                  <?php                   
                                    foreach ($conn->query($sql_transport) as $result_transport) 
                                    {

                                      if(isset($selectedArr['transport']) && in_array($result_transport['id'], $selectedArr['transport']))
                                       {

                                          echo "<option  value='" .$result_transport['id']. "' selected>" .$result_transport['trans_name']. "</option>";
                                       }
                                       else
                                       {
                                         echo "<option  value='" .$result_transport['id']. "'>" .$result_transport['trans_name']. "</option>";
                                       }
                ...
                <div class="card mt-3">
                    <div class="card-header">Truck Master</div>
                      <div class="card-body">
                    ...
                    <?php if (!isset($_SESSION['truck_filter_data'])) {

                      $query = "SELECT COUNT(*) FROM truck_master";     
